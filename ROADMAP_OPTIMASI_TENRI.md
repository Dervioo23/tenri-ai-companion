...
| 4. Pipeline event-driven | Belum dimulai | Refactor besar ini tetap tahap berikutnya setelah data rehearsal membuktikan Tahap 1-3 stabil. |
...
Keputusan operasional saat ini: jalankan rehearsal baru dengan `ELEVENLABS_STREAMING=true`, kumpulkan sedikitnya 20 turn, lalu bandingkan p50/p95 baru. Jangan memulai refactor Tahap 4 sebelum data tersebut tersedia.
